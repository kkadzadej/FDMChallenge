"""
A quick run point for the "app" to show the main results and the endpoint. More info in README.md.
...
if __name__ == "__main__":
    ...
    response = requests.get("http://127.0.0.1:8000/september_batches/").json()
    print(response)